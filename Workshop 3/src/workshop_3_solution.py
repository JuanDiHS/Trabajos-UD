"""
this program update helps to the user to interacting with a graphic interface to make the 
application more interactive, furthermore make a better structure with the backend, frontend and the 
oriented-services structure

Author: Juan Diego Hernández
"""
